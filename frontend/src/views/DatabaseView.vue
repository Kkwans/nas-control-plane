...
.database-project__header { display:grid; min-height:64px; grid-template-columns:auto minmax(0,1fr) auto auto; align-items:center; gap:11px; padding:10px 16px; border-bottom:1px solid var(--ncp-line); background:#fff; }
...
.database-project__header strong { overflow:hidden; font-size:.94rem; text-overflow:ellipsis; white-space:nowrap; }
.database-project__header small { color:var(--ncp-text-subtle); font-size:.76rem; }
...
.database-table{overflow:hidden}.database-table__head,.database-row{display:grid;grid-template-columns:minmax(260px,1.25fr) minmax(150px,.7fr) 150px minmax(260px,1.25fr) 82px;align-items:center;gap:14px}.database-table__head{min-height:44px;padding:0 16px;background:var(--ncp-surface-quiet);color:var(--ncp-text-muted);font-size:.78rem;font-weight:720}.database-row{min-height:74px;padding:10px 16px;border-top:1px solid var(--ncp-line);transition:background var(--ncp-duration-fast),box-shadow var(--ncp-duration-fast)}.database-row:hover{background:var(--ncp-surface-hover);box-shadow:inset 3px 0 0 var(--ncp-primary)}.database-identity{display:flex;min-width:0;align-items:center;gap:11px}.database-identity>div{display:grid;min-width:0;gap:2px}.database-identity strong,.database-identity small,.database-row code{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.database-identity strong{font-size:.9rem}.database-identity small{color:var(--ncp-text-subtle);font-size:.75rem}.database-module{overflow:hidden;color:var(--ncp-text-muted);font-size:.82rem;text-overflow:ellipsis;white-space:nowrap}.driver-badge{justify-self:start;padding:4px 8px;border-radius:7px;background:var(--ncp-primary-soft);color:var(--ncp-primary-strong);font-size:.74rem;font-weight:720}.database-row code{color:var(--ncp-text-muted);font-family:var(--ncp-font-mono);font-size:.76rem}.database-row--skeleton i{width:75%;height:12px}.database-project__header--skeleton>i{width:38px;height:38px;border-radius:10px}.database-project__header--skeleton>div i:first-child{width:180px;height:12px}.database-project__header--skeleton>div i:last-child{width:90px;height:9px}
