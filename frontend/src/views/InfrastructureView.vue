...
.system-grid{grid-template-columns:minmax(0,1.15fr) minmax(360px,.85fr)}
.facts-panel{align-self:start}
.fact-grid{grid-template-columns:repeat(3,minmax(0,1fr));padding:8px 16px 16px}
.fact-grid>div{padding:13px 12px;border-bottom:0}
.fact-grid>div:nth-child(n+4){border-top:1px solid var(--ncp-line)}
@media(max-width:1180px){.system-grid{grid-template-columns:1fr}.fact-grid{grid-template-columns:repeat(3,minmax(0,1fr))}}
@media(max-width:760px){.fact-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.fact-grid>div:nth-child(n+3){border-top:1px solid var(--ncp-line)}}
@media(max-width:520px){.fact-grid{grid-template-columns:1fr}.fact-grid>div:nth-child(n+2){border-top:1px solid var(--ncp-line)}}
</style>
